...
## Stato Attuale del Progetto (v2.5.0)
...
- **Graph Cascading Engine:**
  - `PIIEntityGraph` con multi-hop traversing a decadimento di confidenza per bonifiche transitive profonde.
...
- Creare il modulo `vector_unforget/adapters/weaviate.py` o `pinecone.py` per l'espansione enterprise.